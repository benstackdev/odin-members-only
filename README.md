...
If you want to build this project for yourself, you'll need to clone this repo and build it with `pnpm i` inside both the `client` and `server` folders. Once you've done that, run `pnpm run dev` in both to boot up the client and server instances.
